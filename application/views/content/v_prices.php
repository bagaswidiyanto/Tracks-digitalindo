...
padding: 20px 0; " class="no-mb">
			...
			<div class="container space"  data-animate="fadeInUp">
                <div class="row"><center>
                    <div class="heading">
                                <h3 style="color: black;">Cek ONGKIR</h3>
                             ...
                             <form action="" method="post"><br>
                                ...
                                <p class="min40"><h4 style="color: black;">Masukan lokasi asal dan tujuan serta berat untuk mengetahui tarif pengiriman kami</h4></p><br>
                                	<div class="row">
                                        <div class="inputform">
                                            <input type="text" id="hint" name="asal" class="dropdown-header form-control  form-rounded" required="required" />
					    <input type="hidden" id="asal" name="dari" class="dropdown-header" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="inputform">
                                            <input type="text" id="hint2" name="ke" class="dropdown-header form-control  form-rounded" required="required"/>
					    <input type="hidden" id="tujuan" name="tujuan" class="dropdown-header" />
                                        </div>
                                    </div>
                                     <div class="row weight">
                                        <div class="inputform">
                                            <input type="text" class="form-control weight   form-rounded" value="1" name ="berat" id="" placeholder="BERAT" required>
                                        </div>
                                    </div>
            ...
            <div class="container"  data-animate="fadeInUp">
                <div class="row"><center>
					...
					<h3 style="color: black;"><?=$asal->kabName;?> ke <?=$tujuan->kabName;?><br><?=$this->input->post('berat');?> kg</h3>
		 			...
		 			<div data-animate="fadeInUp"> 
               			...
               			<tr style="background-color:#35498E;color:#fff;">
               			<th>Service</th>
               			<!-- <th>Deskripsi</th> -->
               			<th>Tarif</th>
               			<th>Estimasi</th>
