                    ...
                    <div class=" align-items-center justify-content-center">
                        <?php foreach ($artikel as $artikel) { ?>
                            <div class="slider_info berita text-center">
                                ...
                                <p class="pText animated fadeInUpBig" style="color: black;"><?= ucfirst(strtolower(str_replace(array('<p>', '</p>'), array('', ''), $artikel->description))) ?></p>
                            </div>
                        <?php } ?>
                    </div>
                </div>
...
<section class="blog_area section-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form role="search" method="get" action="<?= base_url(); ?>blog" data-aos="fade-up" data-aos-duration="1000" style="text-align: center; padding-bottom: 50px;">
        ...
        <div class="row">
            ...
            ?>
                    <div class="col-lg-4 mb-5 mb-lg-0" data-aos="fade-up" data-aos-duration="2000" style="padding-bottom: 30px;">
                        <div class="testmonial_text" title="<?= $b->Title; ?>" style="background: #fff; padding: 15px;  border-radius: 20px; box-shadow: 0px 4px 40px rgba(0, 0, 0, 0.05); height: 23rem;">
                            ...
                            <a href="<?= base_url(); ?>blog/baca/<?= $b->slug; ?>" target="_blank">
                                <h5 class="content" style="color: #898989; padding-top: 10px;"><?= substr(strip_tags($b->content), 0, 100); ?>...</h5>
                            </a>
                        </div>
                    </div>
                <?php
