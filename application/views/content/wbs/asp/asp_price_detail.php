...
<body>
    ...
    <div>
        ...
        <img src="https://asp.tracks-app.com/modul/company/foto/foto_WhatsApp%20Image%202022-04-08%20at%209.33.22%20AM.jpeg" class="asp">
    </div>
    ...
    curl_setopt_array($curlLog, array(
        CURLOPT_URL => 'https://asp.tracks-app.com/restapi/tracking/detail/android/progi/?key=753453551d67646fb16eaf3c4a6a7405&awb=' . $tracking,
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://asp.tracks-app.com/restapi/tracking/android/progi/?key=753453551d67646fb16eaf3c4a6a7405&awb=" . $tracking,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
        ...
        <div class="section-heading">
            ...
            <?php foreach ($isi->data as $key) { ?>
                ...
                <center>
                    ...
                    <br><br>
                    <a href="<?= base_url(); ?>wbs/asp">Back</a>
                </center>
            <?php } ?>
        </div>
    </div>
