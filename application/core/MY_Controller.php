...
class MY_Controller extends CI_Controller
{
	...
	public function layout()
	{
		...
		$this->data['website'] = $this->CI->db->get('tbl_websitetrack')->row();
		...
		$this->data['sosmed'] = $this->CI->db->get('tbl_sosmedtrack')->result();
	...
	{
		$w = $this->CI->db->query("SELECT * from tbl_navigation where parent=" . $parent . " and topbar=1 order by `sort` asc");
